...
{
    protected bool $disableHydraCommands = false;

    protected bool $disableHydraApi = false;
    ...
    protected function defineEnvironment($app): void
    {
        ...
        $app['config']->set('tyro.disable_commands', $this->disableHydraCommands);
        $app['config']->set('tyro.disable_api', $this->disableHydraApi);
    }
